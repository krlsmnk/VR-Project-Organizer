...
namespace EliCDavis.RecordAndPlay.Editor
{
    ...
    internal class RecordingWindow : EditorWindow
    {
        ...
        private static void LogPlayModeState(PlayModeStateChange state)
        {
            ...
            {
                recorder.Finish().SaveToAssets(recordingName);
            }
        }
        ...
        private void DisplayReasonCantRecord()
        {
            ...
            EditorGUILayout.LabelField(ReasonCantRecord(), centerStyle);
        }
